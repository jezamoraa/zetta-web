...
public class SalesOrderService_GetByOrderNumberWithDetail_Test extends SpringTest {
	...
	@Test
	public void test() {
		salesOrderService.deleteByOrderNumber(2232);

		Assert.assertNull(salesOrderService.getByOrderNumberWithDetail(2232));
