...
public class UsuarioService_UpdatePassword_OK extends SpringTest {
	...
	@Test
	public void testUpdateOK() throws ApplicationException {
		try {
			usuarioAActualizar.setContrasena("secret");
			usuarioAActualizar.setRepetirContrasena("secret");

			service.doUpdatePassword(new ParamInputTO<Usuario>(null, usuarioAActualizar)).getOutput();
		} catch (ApplicationException e) {
